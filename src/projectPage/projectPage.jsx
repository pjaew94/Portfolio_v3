    ...
    <div name='projects' className='project-page-container'>
      <div className="project-page-container-2" ref={project}>
        <div className="projects-container">
          <a onMouseEnter={projectHover1} onMouseLeave={projectUnhover1} target='_blank' class='p1 project-link' href='https://jae-park.netlify.com/'>Project One</a>
          <a onMouseEnter={projectHover2} onMouseLeave={projectUnhover2} target='_blank' class='p2 project-link' href='https://ridnyi-house-project.netlify.com'>Project Two</a>
        </div>
